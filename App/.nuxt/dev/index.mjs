globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, isEvent, createEvent, getRequestHeader, splitCookiesString, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/devalue/index.js';
import { renderToString } from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/ofetch/dist/node.mjs';
import destr from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/scule/dist/index.mjs';
import { klona } from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/defu/dist/defu.mjs';
import { hash } from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/radix3/dist/index.mjs';
import fs from 'node:fs/promises';
import { version, unref } from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "stacRoot": "/stac",
    "mapboxToken": "pk.eyJ1IjoiZ2xvYmFsLWRhdGEtdmlld2VyIiwiYSI6ImNqdG9lYWQ3NTFsNWk0M3Fqb2Q5dXBpeWUifQ.3DvxuGByM33VNa59rDogWw"
  }
};
...
const serverAssets = [{"baseName":"server","dir":"C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\kras\\Documents\\GitHub\\global-coastal-atlas\\App","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\kras\\Documents\\GitHub\\global-coastal-atlas\\App\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\kras\\Documents\\GitHub\\global-coastal-atlas\\App\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\kras\\Documents\\GitHub\\global-coastal-atlas\\App\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\kras\\Documents\\GitHub\\global-coastal-atlas\\App\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _L87PZSKYJU = (function(nitro) {
...
const _9OxMv1 = defineEventHandler(async (event) => {
  var _a;
  let path = (_a = event.context.params) == null ? void 0 : _a["_"];
  if (!path)
...
const _lazy_whn92i = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_whn92i, lazy: true, middleware: false, method: undefined },
  { route: '/stac/**', handler: _9OxMv1, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_whn92i, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/Users/kras/Documents/GitHub/global-coastal-atlas/App/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
