...
if __name__ == "__main__":
    ...
    # opening metadata
    metadata_fp = gca_data_dir.joinpath("metadata_waves_by_cowclip.json")
    ...
    DATASET_FILENAME = "waves_by_cowclip.zarr"
    ...
    TEMPORAL_DIMENSION = "rp"  # False, None or str; temporal ""
