...
if __name__ == "__main__":
    ...
    # opening metadata
    metadata_fp = dataset_dir.joinpath("metadata_shorelinemonitor_future.json")
    ...
    DATASET_FILENAME = "shoreline_monitor_fut.zarr"
    VARIABLES = ["changerate"]  # xarray variables in dataset
