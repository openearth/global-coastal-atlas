...
if __name__ == "__main__":
    ...
    IN_FILENAME = "World_Protected_Areas.zarr"  # original filename as on P drive
    OUT_FILENAME = "Vul_World_Protected_Areas.zarr"  # file name in the cloud and on MapBox
    VARIABLES = [
        ""
    ...
    #    'Seven seas (open ocean)', 'South America', 'unknown']
    }
