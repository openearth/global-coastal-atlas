...
if __name__ == "__main__":
    ...
    for i,GCM in tqdm(enumerate(GCM_all),desc="GCM completed"):# Project paths & files (manual input)
        ...
        dataset_dir = gca_data_dir.joinpath(r"01_Hazards\02_Future\Extreme_Wave_Height\GCM_All_CMIP6-phase2_Projection_2071-2100",GCM)
       
        IN_FILENAME = f"{GCM}_WW3_3Hourly_2071-2100.zarr"
        OUT_FILENAME = f"Haz-{GCM}_Projected_71-100.zarr"
