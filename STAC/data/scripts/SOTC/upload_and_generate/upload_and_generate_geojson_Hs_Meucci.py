...
if __name__ == "__main__":
    ...
    IN_FILENAME = "Delta_Hs_21st_century_Meucci_final.zarr"  # original filename as on P drive
    OUT_FILENAME = "Haz-Hs_Meucci_2100.zarr"  # file name in the cloud and on MapBox

    VARIABLES = ["Meucci_RP100_percent_change_end21C_RCP45", 
