...
if __name__ == "__main__":
    ...
    dataset_dir = gca_data_dir.joinpath(r"03_Vulnerability\Roads_Density\Raster\GRIP4_density_total\cogs")
    cred_dir = pathlib.Path(p_drive, "11207608-coclico", "FASTTRACK_DATA")

    DIR_NAME="Vul-Roads_Density_COGs"

    # IN_FILENAME = name  # original filename as on P drive
    # OUT_FILENAME = name  # file name in the cloud and on MapBox
    # # VARIABLES = [
    #     "esl"
    ...
    # ADDITIONAL_DIMENSIONS = ["Scenario","Time_Horizon"]
    ...
    # DIMENSIONS_TO_IGNORE = ["nstations"]  # dimensions to ignore
    ...
    dir_to_google_cloud(
        dir_path=str(dataset_dir), gcs_project=GCS_PROJECT, bucket_name=BUCKET_NAME, bucket_proj=BUCKET_PROJ, dir_name=DIR_NAME
    )
