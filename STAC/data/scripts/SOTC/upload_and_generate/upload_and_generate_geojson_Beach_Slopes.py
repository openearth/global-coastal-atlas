...
if __name__ == "__main__":
    ...
    dataset_dir = gca_data_dir.joinpath(r"02_Exposure\Slopes-DOC\Nearshore_Slopes")
    cred_dir = pathlib.Path(p_drive, "11207608-coclico", "FASTTRACK_DATA")
    IN_FILENAME = "Nearshore_Slopes_final.zarr"  # original filename as on P drive
    OUT_FILENAME = "Exp-NS_Slopes.zarr"  # file name in the cloud and on MapBox
    VARIABLES = [
        "slope",
        "dc",
        "error_code"
