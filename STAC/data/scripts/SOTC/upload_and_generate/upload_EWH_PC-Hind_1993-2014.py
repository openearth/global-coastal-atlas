...
if __name__ == "__main__":
    ...
    BUCKET_PROJ = "gca/SOTC/Haz-Offshore_Waves/Present_Climate/GCM_Hindcasts_CMIP6"  # deltares bucket project
    ...
    for i,GCM in tqdm(enumerate(GCM_all),desc="GCM completed"):# Project paths & files (manual input)
        ...
        dataset_dir = gca_data_dir.joinpath(r"01_Hazards\02_Future\Extreme_Wave_Height\GCM_All_8_CMIP6_Hindcast_1993-2014",GCM)
       
        IN_FILENAME = f"{GCM}_WW3_3Hourly_1993-2014.zarr"
        OUT_FILENAME = f"Haz-{GCM}_Hind_93-14.zarr"
