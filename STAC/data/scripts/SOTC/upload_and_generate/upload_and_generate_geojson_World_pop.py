...
if __name__ == "__main__":
    ...
    IN_FILENAME = "World_Pop_100m_final.zarr"  # original filename as on P drive
    OUT_FILENAME = "Exp_world_pop.zarr"  # file name in the cloud and on MapBox
    VARIABLES = [
        "Tot_pop_count"
