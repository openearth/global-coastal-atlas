...
if __name__ == "__main__":
    ...
    IN_FILENAME = "Child_Mortality_final.zarr"  # original filename as on P drive
    OUT_FILENAME = "Vul-Inf_Mort.zarr"  # file name in the cloud and on MapBox
    VARIABLES = [
        "Infant_mort_3yr_mean"
    ...
    MAP_SELECTION_DIMS = {
        ...
        # "time": pd.date_range(start='1960-01-01', end='2022-01-01', freq='AS').to_numpy()
    }
    ...
    lat=ds.lat.fillna(0),
    lon=ds.lon.fillna(0),
    Infant_mort_3yr_mean=ds.Infant_mort_3yr_mean.fillna(0),
    )
    ds=ds.rename_vars({"Infant_mort_3yr_mean":"Deaths_3yr"})
    VARIABLES = ["Deaths_3yr"]
