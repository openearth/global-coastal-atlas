...
if __name__ == "__main__":
    ...
    dataset_dir = gca_data_dir.joinpath(r"01_Hazards\02_Future\Extreme_Wave_Height\GCM_Projection_2040-2050")
    cred_dir = pathlib.Path(p_drive, "11207608-coclico", "FASTTRACK_DATA")
    IN_FILENAME = "EC-EARTH_WW3_3Hourly_2040-2050.zarr"  # original filename as on P drive
    OUT_FILENAME = "Haz-GCM_40-50.zarr"  # file name in the cloud and on MapBox
    VARIABLES = [
        "hs_1_26",
        "hs_5_85"
    ...
    MAP_SELECTION_DIMS = {
        "time": pd.date_range(start='2040-01-01', end='2050-01-01', freq='AS').to_numpy()  # TODO: fix bug. If I put ["ssp126", "ssp245", "ssp585"] if doesn't work properly as nscenarios and scenarios are disconnected in the variable. If I put nscenarios = [0,1,2] (like for ensembles) I get an error because of the disconnection
