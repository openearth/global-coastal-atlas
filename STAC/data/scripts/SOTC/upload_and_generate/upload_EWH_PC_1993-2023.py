...
if __name__ == "__main__":
    ...
    BUCKET_PROJ = "gca/SOTC/Haz-Offshore_Waves/Present_Climate"  # deltares bucket project
    ...
    IN_FILENAME = "ERA5_Hourly_1993-2023.zarr"  # original filename as on P drive
    OUT_FILENAME = "Haz-ERA5_93-23.zarr"  # file name in the cloud and on MapBox
    VARIABLES = [
        "swh",
    ...
    #Adding station demension for geojson
