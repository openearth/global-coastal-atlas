...
if __name__ == "__main__":
    ...
    IN_FILENAME = "PC_FC_RL_merged_Carib_final.zarr"  # original filename as on P drive
    OUT_FILENAME = "SOTC-Coastal_Risk_Levels_PC_FC.zarr"  # file name in the cloud and on MapBox
    # OUT_FILENAME = "SOTC-CRL.zarr"  # file name in the cloud and on MapBox
    VARIABLES = [
...
######################################## VARIABLE NAMES TOO LONG FOR MAPBOX ####################
    OUT_FILENAME = "SOTC-CRL.zarr"
    # Define the mapping from old variable names to new variable names
    NewVARIABLES = [
    "Cat3_TC_PC_Risk_Level",
    "Erosion_PC_Risk_Level",
    "Land_Subs_PC_Risk_Level",
    "EWH_PC_Risk_Level",
    "ESL_PC_Risk_Level"
]
    rename_dict = dict(zip(VARIABLES, NewVARIABLES))
