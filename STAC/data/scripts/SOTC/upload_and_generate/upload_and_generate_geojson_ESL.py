...
if __name__ == "__main__":
    ...
    dataset_dir = gca_data_dir.joinpath(r"01_Hazards\01_Present\Extreme_Sea_Level")
    cred_dir = pathlib.Path(p_drive, "11207608-coclico", "FASTTRACK_DATA")
    IN_FILENAME = "Extreme_Sea_Level_final.zarr"  # original filename as on P drive
    OUT_FILENAME = "Haz-ESL.zarr"  # file name in the cloud and on MapBox
    VARIABLES = [
        "esl"
