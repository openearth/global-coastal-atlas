...
if __name__ == "__main__":
    ...
    gca_data_dir = pathlib.Path(
        ...
        "MSc_students\ClenmarRowe\Data\All_Datasets",
        r"Orig_Datasets\01_Hazards\01_Present",
    )
    dataset_dir = gca_data_dir.joinpath("Extreme_Sea_Level")

    # opening metadata
    metadata_fp = dataset_dir.joinpath("ESL_100RP_metadata.json")
    ...
    DATASET_FILENAME = "Haz-ESL.zarr"
    VARIABLES = ["esl"]  # xarray variables in dataset
    X_DIMENSION = "lon"  # False, None or str; spatial lon dim used by datacube
    Y_DIMENSION = "lat"  # False, None or str; spatial lat dim ""
    TEMPORAL_DIMENSION = "Time_Horizon"  # False, None or str; temporal ""
        #####
