...
if __name__ == "__main__":
    ...
    dataset_dir = gca_data_dir.joinpath(r"03_Vulnerability\Mean_Years_of_Schooling")

    # opening metadata
    metadata_fp = dataset_dir.joinpath("metadata_mean_years_of_schooling.json")
    ...
    DATASET_FILENAME = "Vul_MYS.zarr"
    VARIABLES = ["mean_years_schooling"]  # xarray variables in dataset
    ...
    UNITS = "Years"
    PLOT_SERIES = "mean_years_schooling"
    PLOT_X_AXIS = "country"
    PLOT_TYPE = "line"
    MIN = 0
    MAX = 3
