...
if __name__ == "__main__":
    ...
    dataset_dir = gca_data_dir.joinpath(r"03_Vulnerability\Recent_Shocks")

    # opening metadata
    metadata_fp = dataset_dir.joinpath("metadata_recent_shocks.json")
    ...
    DATASET_FILENAME = "Vul_RS.zarr"
    VARIABLES = ["recent_shocks"]  # xarray variables in dataset
    ...
    UNITS = "Deaths by Natural Disasters"
    PLOT_SERIES = "recent_shocks"
    PLOT_X_AXIS = "country"
    PLOT_TYPE = "line"
    MIN = 0
    MAX = 3
