...
if __name__ == "__main__":
    ...
    for i,GCM in tqdm(enumerate(GCM_all),desc="GCM completed"):# Project paths & files (manual input)
        ...
        # opening metadata
        metadata_fp = dataset_dir.joinpath(f"metadata_{GCM}_2040-2100.json")
        ...
        DATASET_FILENAME = f"Haz-{GCM}_Projected_40-100.zarr"
        VARIABLES = [f"hs_1_26",f"hs_5_85"]  # xarray variables in dataset
