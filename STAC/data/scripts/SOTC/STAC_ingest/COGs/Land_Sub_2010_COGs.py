...
if __name__ == "__main__":
   ...
   # hard-coded input params at project level
    ...
    dataset_dir = gca_data_dir.joinpath(r"01_Hazards\01_Present\Land_Subsidence\GSH")
    DATASET_FILENAME = "GSH.tif"  # sample from source data

    # opening metadata
    metadata_fp = dataset_dir.joinpath("metadata_global_land_subsidence.json")
    ...
    COLLECTION_ID = "Haz-Land_Sub_2010_COGs"  # name of stac collection
    TEMPLATE_COLLECTION = "template"  # stac template for dataset collection
    CITATION=metadata["CITATION"]
    START_DATETIME=datetime.datetime(2010, 1, 1, tzinfo=datetime.timezone.utc)
    BLOCK_TIME_COORD=pd.Timestamp(2010, 1, 1).isoformat()
    HREF_PREFIX = "https://storage.googleapis.com/dgds-data-public/gca/SOTC/Haz-Land_Sub_2010_COGs/"
    THUMBNAIL_PHOTO="https://storage.googleapis.com/dgds-data-public/gca/SOTC/Haz-Land_Sub_2010_COGs/Land_Subsidence.png"
