...
if __name__ == "__main__":
   ...
   # hard-coded input params at project level
    ...
    dataset_dir = gca_data_dir.joinpath(r"03_Vulnerability\Roads_Density\Raster\GRIP4_density_total")
    DATASET_FILENAME = "grip4_total_dens_m_km2.tif"  # sample from source data

    # opening metadata
    metadata_fp = dataset_dir.joinpath("metadata_grip4_total_dens_m_km2.json")
    ...
    COLLECTION_ID = "Vul-Roads_Density_COGs"  # name of stac collection
    TEMPLATE_COLLECTION = "template"  # stac template for dataset collection
    CITATION=metadata["CITATION"]
    START_DATETIME=datetime.datetime(2018, 1, 1, tzinfo=datetime.timezone.utc)
    BLOCK_TIME_COORD=pd.Timestamp(2018, 1, 1).isoformat()
    HREF_PREFIX = "https://storage.googleapis.com/dgds-data-public/gca/SOTC/Vul-Roads_Density_COGs/"
    THUMBNAIL_PHOTO="https://storage.googleapis.com/dgds-data-public/gca/SOTC/Vul-Roads_Density_COGs/Roads_Density_GRIP4.png"
