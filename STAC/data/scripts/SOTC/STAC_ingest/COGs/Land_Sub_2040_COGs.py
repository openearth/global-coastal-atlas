...
if __name__ == "__main__":
   ...
   # hard-coded input params at project level
    ...
    dataset_dir = gca_data_dir.joinpath(r"01_Hazards\02_Future\Land_Subsidence\GSH_2040")
    DATASET_FILENAME = "GSH_2040.tif"  # sample from source data

    # opening metadata
    metadata_fp = dataset_dir.joinpath("metadata_global_land_subsidence_2040.json")
    ...
    COLLECTION_ID = "Haz-Land_Sub_2040_COGs"  # name of stac collection
    TEMPLATE_COLLECTION = "template"  # stac template for dataset collection
    CITATION=metadata["CITATION"]
    START_DATETIME=datetime.datetime(2040, 1, 1, tzinfo=datetime.timezone.utc)
    BLOCK_TIME_COORD=pd.Timestamp(2040, 1, 1).isoformat()
    HREF_PREFIX = "https://storage.googleapis.com/dgds-data-public/gca/SOTC/Haz-Land_Sub_2040_COGs/"
    THUMBNAIL_PHOTO="https://storage.googleapis.com/dgds-data-public/gca/SOTC/Haz-Land_Sub_2040_COGs/Land_Subsidence.png"
    ...
    for tiff_file in tqdm(tiff_files,desc="items added to collection"):
        ...
        urljoin( HREF_PREFIX,tiff_file.replace(prefix,"")), engine="rasterio", mask_and_scale=False
        )
