...
if __name__ == "__main__":
   ...
   # hard-coded input params at project level
    ...
    #########
    ls_chunk_size = 2**12 # USED IN PREVIOUS CHUNKING SEE
    #########
    ds = xr.open_dataset(data_fp, chunks={"x": ls_chunk_size, "y": ls_chunk_size})
    ...
    # minx, miny, maxx, maxy = world.geometry.bounds.iloc[0].tolist()
