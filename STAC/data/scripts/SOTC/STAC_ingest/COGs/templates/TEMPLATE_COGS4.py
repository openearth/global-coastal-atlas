...
if __name__ == "__main__":
   ...
   # hard-coded input params at project level
    ...
    COLLECTION_ID = "Land_Subs_2010"  # name of stac collection
    TEMPLATE_COLLECTION = "template"  # stac template for dataset collection
    CITATION=metadata["CITATION"]
    START_DATETIME=datetime.datetime(2010, 01, 01, tzinfo=datetime.timezone.utc)
    HREF_PREFIX = "https://storage.googleapis.com/dgds-data-public/gca/SOTC/Haz-Land_Sub_2010_COGs/"
    THUMBNAIL_PHOTO="https://th.bing.com/th/id/OIP.g02Zw_hKJ8KYsFKRuzYTAAHaGq?rs=1&pid=ImgDetMain"
