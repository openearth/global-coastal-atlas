...
if __name__ == "__main__":
    ...
    dataset_dir = gca_data_dir.joinpath(r"03_Vulnerability\World Database on Protected Areas")

    # opening metadata
    metadata_fp = dataset_dir.joinpath("metadata_world_database_on_protected_areas.json")
    ...
    DATASET_FILENAME = "Vul_World_Protected_Areas.zarr"
    VARIABLES = ["GOV_TYPE"]  # xarray variables in dataset
    ...
    UNITS = "Governance type"
    PLOT_SERIES = "GOV_TYPE"
    PLOT_X_AXIS = "country"
    PLOT_TYPE = "line"
    MIN = 0
    MAX = 3
