...
if __name__ == "__main__":
    ...
    BUCKET_PROJ = "gca/SOTC/Haz-Offshore_Waves/Present_Climate"
    ...
    dataset_dir = gca_data_dir.joinpath(r"01_Hazards\01_Present\Extreme_Wave_Height")

    # opening metadata
    metadata_fp = dataset_dir.joinpath("metadata_ERA5_copernicus_1993_2023.json")
    ...
    DATASET_FILENAME = "Haz-ERA5_93-23.zarr"
    VARIABLES = ["swh"]  # xarray variables in dataset
