...
if __name__ == "__main__":
    ...
    BUCKET_PROJ = "gca/SOTC/Haz-Offshore_Waves/Future_Climate/2070-2100_Phase2_WW3"  # deltares bucket project
    ...
    for i,GCM in tqdm(enumerate(GCM_all),desc="GCM completed"):# Project paths & files (manual input)
        ...
        dataset_dir = gca_data_dir.joinpath(r"01_Hazards\02_Future\Extreme_Wave_Height\GCM_All_CMIP6-phase2_Projection_2071-2100")

        # opening metadata
        metadata_fp = dataset_dir.joinpath(f"metadata_{GCM}_2071-2100.json")
        ...
        DATASET_FILENAME = f"Haz-{GCM}_Projected_71-100.zarr"
        VARIABLES = [f"hs_1_26_{GCM}",f"hs_5_85_{GCM}"]  # xarray variables in dataset
