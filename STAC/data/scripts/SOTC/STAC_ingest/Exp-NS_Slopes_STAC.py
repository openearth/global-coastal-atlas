...
if __name__ == "__main__":
    ...
    gca_data_dir = pathlib.Path(
        ...
        r"02_Exposure\Slopes-DOC",
    )
    dataset_dir = gca_data_dir.joinpath("Nearshore_Slopes")

    # opening metadata
    metadata_fp = dataset_dir.joinpath("metadata_Nearshore_slope.json")
    ...
    DATASET_FILENAME = "Exp-NS_Slopes.zarr"
    VARIABLES = ["slope", "dc", "error_code"]  # xarray variables in dataset
