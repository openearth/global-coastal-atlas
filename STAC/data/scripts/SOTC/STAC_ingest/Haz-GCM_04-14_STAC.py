...
if __name__ == "__main__":
    ...
    dataset_dir = gca_data_dir.joinpath(r"01_Hazards\02_Future\Extreme_Wave_Height\GCM_Hindcast_2004-2014")

    # opening metadata
    metadata_fp = dataset_dir.joinpath("metadata_EC-Earth-2004-2014.json")
    ...
    DATASET_FILENAME = "Haz-GCM_04-14.zarr"
    VARIABLES = ["hs"]  # xarray variables in dataset
