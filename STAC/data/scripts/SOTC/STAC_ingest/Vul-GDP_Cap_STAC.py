...
if __name__ == "__main__":
    ...
    # opening metadata
    metadata_fp = dataset_dir.joinpath("metadata_GDP_Cap.json")
    ...
    DATASET_FILENAME = "Vul-GDP_Cap.zarr"
    VARIABLES = ["gdp_ppp_cap_3_yr"]  # xarray variables in dataset
