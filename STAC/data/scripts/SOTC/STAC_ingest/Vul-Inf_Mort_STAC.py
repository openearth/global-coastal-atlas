...
if __name__ == "__main__":
    ...
    dataset_dir = gca_data_dir.joinpath(r"03_Vulnerability\Child_Mortality")

    # opening metadata
    metadata_fp = dataset_dir.joinpath("metadata_infant_mortality.json")
    ...
    DATASET_FILENAME = "Vul-Inf_Mort.zarr"
    VARIABLES = ["Infant_mort_3yr_mean"]  # xarray variables in dataset
    ...
    UNITS = "Deaths"
    PLOT_SERIES = "Infant_mort_3yr_mean"
    PLOT_X_AXIS = "country"
    PLOT_TYPE = "line"
    MIN = 0
    MAX = 3
