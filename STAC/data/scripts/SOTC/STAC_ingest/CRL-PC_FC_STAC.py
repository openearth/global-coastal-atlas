...
if __name__ == "__main__":
    ...
    gca_data_dir = pathlib.Path(
        ...
        r"MSc_students\ClenmarRowe\Data",
       
    )
    dataset_dir = gca_data_dir.joinpath(r"Processed_Risk_Levels_PC_FC_Merged\Caribbean_Thesis_builtup_pop_ns_fix")

    # opening metadata
    metadata_fp = dataset_dir.joinpath("STOC_metadata.json")
    ...
    DATASET_FILENAME = "SOTC-Coastal_Risk_Levels_PC_FC.zarr"
    VARIABLES = [
        "country",
    ...
    UNITS = ""
    PLOT_SERIES = "Cat3_Hurricane_Return_Period_PC_PC___Risk_Level"
    PLOT_X_AXIS = "country"
    PLOT_TYPE = "line"
    MIN = 0
    MAX = 3
