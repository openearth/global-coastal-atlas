...
if __name__ == "__main__":
    ...
    # opening metadata
    metadata_fp = dataset_dir.joinpath("metadata_subsidence.json")
    ...
    DATASET_FILENAME = "Global_TLS.zarr"
    VARIABLES = ["eapa", "egdp", "epsi"]  # xarray variables in dataset
    ...
    ADDITIONAL_DIMENSIONS = ["time"]  # Empty list or list of str; additional dims ""
    ...
    UNITS = "m"
    PLOT_SERIES = (  # leave empty if not applicable (i.e. the dimensions are already span up)
        ""
    )
    PLOT_X_AXIS = "time"
    PLOT_TYPE = "line"
    ...
    #     "thumbnail",
    #     pystac.Asset(
    #         "https://storage.googleapis.com/dgds-data-public/gca/assets/thumbnails/"
    #         + COLLECTION_ID
    #         + ".png",  # noqa: E501
    #         title="Thumbnail",
